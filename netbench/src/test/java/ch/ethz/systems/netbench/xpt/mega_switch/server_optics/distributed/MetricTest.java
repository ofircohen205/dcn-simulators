...
public class MetricTest {
    ...
    public void testDoubleFlow() {
        ...
        FlowStartEvent fse2 = new FlowStartEvent(0, source2.getTransportLayer(), dest2.getIdentifier(), 2000000, jobId);
    ...
    public void testDoubleFlowSameSource() {
        ...
        FlowStartEvent fse = new FlowStartEvent(0, source.getTransportLayer(), dest.getIdentifier(), 20000, jobId);
        FlowStartEvent fse2 = new FlowStartEvent(0, source.getTransportLayer(), dest2.getIdentifier(), 2000000, jobId);
        Simulator.registerEvent(fse);
        Simulator.registerEvent(fse2);
