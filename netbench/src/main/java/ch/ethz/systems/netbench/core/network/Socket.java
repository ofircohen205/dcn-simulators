...
public abstract class Socket {
    ...
    protected final long estimatedFlowSizeByte;
     ...
     * @param estimatedFlowSizeByte Estimated size of the flow in bytes
    ...
    protected void initLogger() {
        // Initialize logger
        this.privateLogger = new FlowLogger(flowId, sourceId, destinationId, flowSizeByte, estimatedFlowSizeByte,
                jobId);
    }
