...
public class SpTcpTransportLayer extends TransportLayer {
     ...
     */
    public SpTcpTransportLayer(int identifier, NBProperties configuration) {
    ...
    protected Socket createSocket(long flowId, int destinationId, long flowSizeByte, long estimatedFlowSizeByte, int jobId) {
        return new SpTcpSocket(this, flowId, this.identifier, destinationId, flowSizeByte, configuration);
    }
