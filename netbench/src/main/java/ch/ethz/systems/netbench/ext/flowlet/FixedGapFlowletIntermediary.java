...
public abstract class FixedGapFlowletIntermediary extends FlowletIntermediary {
    ...
    public FixedGapFlowletIntermediary(NBProperties configuration) {
        super(configuration);
        this.FLOWLET_GAP_NS = configuration.getLongPropertyOrFail(Constants.Flowlet.FLOWLET_GAP_NS);
    }
    ...
    protected boolean flowletGapExceeded(long flowId) {
        ...
        // NetworkDevice flowlet if the time between now and the last packet being
