...
public class PFabricWebSearchUpperBoundFSD extends FlowSizeDistribution {
    ...
    public double getMeanFlowSizeByte() {
        return 0.15 * 10000 + 0.05 * 20000 + 0.1 * 30000 + 0.1 * 50000 + 0.13 * 80000 + 0.07 * 200000
                + 0.1 * 1000000 + 0.1 * 2000000 + 0.1 * 5000000 + 0.07 * 10000000 + 0.03 * 30000000;
    }

    public String toString() {
        return "PFabric Web Search Upper Bound FSD(mean=" + getMeanFlowSizeByte() + ")";
    }
}
