...
public class EdgeColoring {
    ...
    public static Map<Long, Integer> colorEdges(Map<Long, ImmutablePair<Integer, Integer>> commodities) {
        ...
        for (Map.Entry<Long, ImmutablePair<Integer, Integer>> entry : commodities.entrySet()) {
