    ...
    public void simpleStarMcffc() {
        ...
        NetworkTestHelper.runTest(simulator, network, new TestBody(simulator, network) {
            ...
            public void test() {
                ...
                Connection conn0 = new Connection(simulator, network.getNode(0), network.getNode(1), 100, -1);
                Connection conn1 = new Connection(simulator, network.getNode(0), network.getNode(1), 100, -1);
                Connection conn2 = new Connection(simulator, network.getNode(0), network.getNode(3), 100, -1);
                Connection conn3 = new Connection(simulator, network.getNode(2), network.getNode(3), 100, -1);
                Connection conn4 = new Connection(simulator, network.getNode(4), network.getNode(3), 100, -1);
                Connection conn5 = new Connection(simulator, network.getNode(0), network.getNode(3), 100, -1);
    ...
    public void simpleStarNaiveMax2() {
        ...
        NetworkTestHelper.runTest(simulator, network, new TestBody(simulator, network) {
            ...
            public void test() {
                ...
                // Add two connections and their flows
                Connection conn0 = new Connection(simulator, network.getNode(0), network.getNode(4), 100, -1);
                simulator.activateConnection(conn0);
